...
//   final List<List<int>> k1 = k1max > k1min ? List.generate(pqrs[1] - pqrs[0] + 1, (i) => [nab[1] + k1min + i, nab[2] + k1min + i]) : [[]];
...
//   final List<List<int>> k2 = k2max > k2min ? List.generate(pqrs[3] - pqrs[2] + 1, (i) => [nab[1] + k2min + i, nab[2] - (k2min + i)]) : [[]];
//   print("k2: $k2");
//   return [...k1, ...k2];
// }
...
// makeMatrix(String line0, String line2, Function func) {
//   final n = int.parse(line0.split(' ')[0]);
//   final pqrs = line2.split(' ').map<int>(int.parse).toList();

//   return List.generate(
//       pqrs[1] - pqrs[0] + 1,
//       (i) => List.generate(pqrs[3] - pqrs[2] + 1, (j) {
//             return func(line0, line2).any((el) => el[0] == pqrs[0] + i && el[1] == pqrs[2] + j) ? "#" : ".";
//           }));
// }
